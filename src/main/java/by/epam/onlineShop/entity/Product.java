...
public class Product implements Identifiable, Serializable {
    ...
    public Product(long id, long categoryId, String name, String description,
            double price, boolean status, String photo, String color, String productSize, long ordersNumber) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        return id == product.id &&
                ...
                productSize.equals(product.productSize) &&
    ...
    public String toString() {
        ...
        result.append(", productSize='").append(productSize).append('\'');
