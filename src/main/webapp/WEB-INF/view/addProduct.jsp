        ...
        <div class="col-6 my-sm-3">
            ...
            <c:if test="${sessionScope.role.name == 'admin'}">
                ...
                <form action="${pageContext.request.contextPath}/online-shop?command=confirmAddingProduct"
                    ...
                    <button style="background-color: deepskyblue" class="btn" type="submit"><fmt:message bundle="${loc}"
                                                                               key="language.add"/></button>
                </form>
                <hr class="dropdown-divider">
                <a style="color:black" href="/online-shop?command=main"><fmt:message bundle="${loc}" key="language.home"/></a>
            </c:if>
        </div>
    </div>
</div>
