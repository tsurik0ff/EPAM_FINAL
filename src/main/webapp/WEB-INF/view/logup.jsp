            ...
            <form action="${pageContext.request.contextPath}/online-shop?command=registration" method="post">
                <div class="row mb-3">
                    <div class="col-sm mb-3">
                        ...
                        <input type="text" style="border-color:black" id="name" name="name" class="form-control"
                    ...
                    <div class="col-sm">
                        ...
                        <input type="text" id="surname" style="border-color:black"  name="surname" class="form-control"
                ...
                <div class="row mb-3">
                    <div class="col-sm mb-3">
                        ...
                        <input type="text" id="patronymic" style="border-color:black" name="patronymic" class="form-control"
                    ...
                    <div class="col-sm">
                        ...
                        <input type="text" id="phone" style="border-color:black" name="phone" class="form-control"
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" style="border-color:black" name="email" id="email"
                           placeholder="name@example.com" required>
                </div>
                <div class="mb-3">
                    <label for="password-first" class="form-label"><fmt:message bundle="${loc}"
                                                                                key="language.password"/></label>
                    <input type="password" style="border-color:black" class="form-control" name="password-first" id="password-first"
                ...
                <div class="mb-3">
                    ...
                    <input type="password" style="border-color:black" class="form-control" name="password-second" id="password-second"
                           placeholder="password" required
                           minlength="8">
                </div>

                <button class="btn" style="border-radius:5px;background-color:deepskyblue;" type="submit" style="color:black"><fmt:message bundle="${loc}"
                                                                           key="language.logUp"/></button>

            </form>
            <hr class="dropdown-divider">
            <p class="text-muted"><fmt:message bundle="${loc}" key="language.haveAccount"/><a
                    style="color:black" href="${pageContext.request.contextPath}/online-shop?command=logIn"> <fmt:message
