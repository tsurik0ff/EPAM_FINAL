                ...
                <div class="card-header" style="color:deepskyblue">
                    <h5><c:out value="${product.name}"/>
                        <c:if test="${sessionScope.role.name == 'admin'}">
                            <a style="color:black;margin-left:100px" href="${pageContext.request.contextPath}/online-shop?command=editProduct&productId=${product.id}">
                                ...
                                <c:if test="${product.status == true}">
                                    ...
                                    <form action=${pageContext.request.contextPath}/online-shop?command=addToBasket
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            <button style="background-color: deepskyblue" type="submit" class="btn btn-outline-primary" name="productId"
                                                    value="${product.id}">
